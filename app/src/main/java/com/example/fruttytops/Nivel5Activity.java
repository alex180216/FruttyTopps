...
public class Nivel5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Nivel5Activity.this, "Nivel 5: Multiplicaciones", Toast.LENGTH_SHORT).show();
            ...
            if(resultado == respuesta_jugador ){//la respuesta es correcta
                ...
                switch (vidas){
                    ...
                    case 0: //SE QUEDO SIN VIDAS, FINALIZA EL JUEGO
                        ...
                        Intent i = new Intent(Nivel5Activity.this, MainActivity.class);
                        startActivity(i);
                        finish();
                        mp.stop();
                        mp.release();
    ...
    public void NumAleatorio(){
        if(score<=49){//estamos en nivel 2
        ...
        }else{//pasamos al activity nivel 6

            string_score = String.valueOf(score);
            string_vidas = String.valueOf(vidas);

            Intent i = new Intent(Nivel5Activity.this, Nivel6Activity.class);
