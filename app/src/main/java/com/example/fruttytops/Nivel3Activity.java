...
public class Nivel3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Nivel3Activity.this, "Nivel 3: Restas basicas", Toast.LENGTH_SHORT).show();
            ...
            if(resultado == respuesta_jugador ){//la respuesta es correcta
                ...
                switch (vidas){
                    ...
                    case 0: //SE QUEDO SIN VIDAS, FINALIZA EL JUEGO
                        ...
                        Intent i = new Intent(Nivel3Activity.this, MainActivity.class);
                        startActivity(i);
                        finish();
                        mp.stop();
                        mp.release();
    ...
    public void NumAleatorio(){
        if(score<=29){//estamos en nivel 3
            ...
            Intent i = new Intent(Nivel3Activity.this, Nivel4Activity.class);
