...
public class Nivel4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Nivel4Activity.this, "Nivel 4: Sumas y Restas", Toast.LENGTH_SHORT).show();
            ...
            if(resultado == respuesta_jugador ){//la respuesta es correcta
                ...
                switch (vidas){
                    ...
                    case 0: //SE QUEDO SIN VIDAS, FINALIZA EL JUEGO
                        ...
                        Intent i = new Intent(Nivel4Activity.this, MainActivity.class);
                        startActivity(i);
                        finish();
                        mp.stop();
                        mp.release();
    ...
    public void NumAleatorio(){
        if(score<=39){//estamos en nivel 3
        ...
        }else{//pasamos al activity nivel 4

            string_score = String.valueOf(score);
            string_vidas = String.valueOf(vidas);

            Intent i = new Intent(Nivel4Activity.this, Nivel5Activity.class);
