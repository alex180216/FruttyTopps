...
public class Nivel1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Nivel1Activity.this, "Nivel 1: Sumas basicas", Toast.LENGTH_SHORT).show();
            ...
            if(resultado == respuesta_jugador ){//la respuesta es correcta
                ...
                switch (vidas){
                    ...
                    case 0: //SE QUEDO SIN VIDAS, FINALIZA EL JUEGO
                        ...
                        Intent i = new Intent(Nivel1Activity.this, MainActivity.class);
                        startActivity(i);
                        finish();
                        mp.stop();
                        mp.release();
    ...
    public void NumAleatorio(){
        if(score<=9){//estamos en nivel 1
            ...
            //el maximo resultado a obtener es 10
            ...
            Intent i = new Intent(Nivel1Activity.this, Nivel2Activity.class);
