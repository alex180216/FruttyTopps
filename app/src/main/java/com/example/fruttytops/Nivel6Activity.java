...
public class Nivel6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Nivel6Activity.this, "Nivel 6: Sumas, Restas y multiplicaciones", Toast.LENGTH_SHORT).show();
            ...
            if(resultado == respuesta_jugador ){//la respuesta es correcta
                ...
                switch (vidas){
                    ...
                    case 0: //SE QUEDO SIN VIDAS, FINALIZA EL JUEGO
                        ...
                        Intent i = new Intent(Nivel6Activity.this, MainActivity.class);
                        startActivity(i);
                        finish();
                        mp.stop();
                        mp.release();
    ...
    public void NumAleatorio(){
        if(score<=100){//estamos en nivel 3

            numAleatorio_uno =(int)(Math.random()*10);
            numAleatorio_dos =(int)(Math.random()*10);

            //ALTERNAME EL OPERADOR
            if(numAleatorio_uno>=0 && numAleatorio_uno<=3){
                resultado = numAleatorio_uno + numAleatorio_dos;
                iv_operador.setImageResource(R.drawable.adicion);

            }else if(numAleatorio_uno>=4 && numAleatorio_uno<=7){
                resultado = numAleatorio_uno - numAleatorio_dos;
                iv_operador.setImageResource(R.drawable.resta);

            }else if(numAleatorio_uno>=7 && numAleatorio_uno<=9){
                resultado = numAleatorio_uno * numAleatorio_dos;
                iv_operador.setImageResource(R.drawable.multiplicacion);
            }

            //el maximo resultado a obtener es 20

            if(resultado>=0){//SI no tenemos numeros negativos
        ...
        }else{//pasamos al activity TERMINO EL JUEGO
            ...
            Toast.makeText(getApplicationContext(), "FELICIDADES HAS TERMINADO EL JUEGO!!", Toast.LENGTH_LONG).show();
